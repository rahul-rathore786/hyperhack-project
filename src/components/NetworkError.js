    ...
    <div className="network-error-container">
      <div className="network-error-card">
        <div className="network-error-header">
          <svg xmlns="http://www.w3.org/2000/svg" className="network-error-icon" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="network-error-content">
          ...
          <div className="network-details">
            <div className="network-detail-item">
              ...
              <span className="network-value">{networkError?.currentNetwork || 'Unknown'}</span>
            </div>
            <div className="network-detail-item">
